                            ...
                            <div class="row">
                                <div class="col-sm-3 mt-3">
                                    <div class="form-group">
                                        ...
                                        <select name="category_name" class="form-select" required disabled>
                                ...
                                <div class="col-sm-3 mt-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="gender_type" required disabled>
                                ...
                                <div class="col-sm-3 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" readonly title="Please Enter Product Name" name="product_name" value="<?= $product_row['product_name'] ?>">
                                    </div>
                                </div>
                                <div class="col-sm-3 mt-3">
                                    <div class="form-group">
                                        <label for="">Product Code <span class="error-imp">*</span></label>
                                        <input type="text" class="form-control" readonly title="Please Enter Product Code" name="product_code" value="<?= $product_row['product_code'] ?>">
                                    </div>
                                </div>
                                <div class="col-sm-3 mt-3">
                                    <div class="form-group">
                                        <label for="">Product Price <span class="error-imp">*</span></label>
                                        <input type="text" class="form-control" readonly onkeypress="return (event.charCode !=8 && event.charCode ==0 || ( event.charCode == 46 || (event.charCode >= 48 && event.charCode <= 57)))" minlength="1" maxlength="10" name="product_price" title="Please Enter Product Price" value="<?= $product_row['product_price'] ?>">
                                    </div>
                                </div>
                                <div class="col-sm-3 mt-3">
                                    <div class="form-group">
                                        <label for="">Product Discount</label>
                                        <input type="text" class="form-control" readonly name="product_discount" onkeypress="return (event.charCode !=8 && event.charCode ==0 || ( event.charCode == 46 || (event.charCode >= 48 && event.charCode <= 57)))" minlength="1" maxlength="10" title="Please Enter Product Discount" value="<?= $product_row['product_discount'] ?>">
                                    </div>
                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    ?>
                                                            <div class="col-sm-6">
                                                                ...
                                                                <input type="text" class="form-control" readonly name="product_qty[]" value="<?= $size_qty_row['quantity'] ?>">
                                                                <input type="hidden" class="form-control" name="sizeqty_id[]" value="<?= $size_qty_row['sizeqty_id'] ?>">
                                                            </div>

                                                            <div class="col-sm-6">
                                                                <label for="">Product Size</label>
                                                                <select name="product_size[]" class="form-select" title="Enter Product Size" required disabled>
                                ...
                                <div class="col-sm-3 mt-5">
                                    <div class="form-group">
                                        ...
                                        <div class="manage-color d-flex">
                                            <select name="product_color" class="form-select mx-1" required disabled>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="update-img mt-2">
                                            <div class="row">
                                                ...
                                                ?>
                                                        <div class="col-sm-4 manage-img p-3">
                                ...
                                <div class="col-sm-12 mt-3">
                                    <div class="form-group">
                                        ...
                                        <textarea name="product_desc" readonly class="form-control" title="Please Enter Product Description" cols="160" rows="8" placeholder="Enter Product Description"><?= $product_row['product_desc'] ?></textarea>
